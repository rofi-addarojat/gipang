...
import { ShoppingBag, Star, Menu, X, CheckCircle2, ShieldCheck, Heart, MessageCircle } from 'lucide-react';
...
export default function LandingPage() {
  ...
  useEffect(() => {
    const unsubSettings = onSnapshot(doc(db, 'settings', 'landingPage'), (doc) => {
      if (doc.exists()) {
  ...
  return (
    <div className="font-sans min-h-screen overflow-x-hidden selection:bg-accent selection:text-white">
      ...
      {/* 1. NAVBAR */}
      <header className={`fixed w-full top-0 z-50 transition-all duration-300 ${isScrolled ? 'bg-primary/95 backdrop-blur-md border-b border-accent/10 shadow-sm py-0' : 'bg-transparent py-2'}`}>
        <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" aria-label="Main Navigation">
          <div className="flex justify-between items-center h-20">
            {/* Logo */}
            <div className="flex-shrink-0 flex items-center">
              <a href="#beranda" aria-label="Kembali ke Beranda" className="flex items-center gap-2 md:gap-3 group" onClick={(e) => handleNavClick(e, '#beranda')}>
                <img 
      ...
      <main>
      {/* 2. HERO SECTION */}
      <section id="beranda" className="pt-28 pb-16 md:pt-36 md:pb-24 overflow-hidden relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            {/* Left Content */}
            <FadeIn direction="right" className="order-2 md:order-1 flex flex-col items-start text-left">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold leading-tight text-text-main mb-6" dangerouslySetInnerHTML={{ __html: cmsData.heroTitle.replace('Manis Legitnya', '<span className="text-accent">Manis Legitnya</span>') }}>
              </h1>
      ...
      <section id="keunggulan" className="py-20 bg-white relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <FadeIn direction="none" className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-text-main" dangerouslySetInnerHTML={{ __html: cmsData.keunggulanTitle }}>
            </h2>
          </FadeIn>
            ...
            <div className="space-y-10">
              <FadeIn direction="up" delay={0.1}>
                <div className="flex gap-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-text-main mb-2">{cmsData.k1Title}</h3>
              ...
              <FadeIn direction="up" delay={0.2}>
                <div className="flex gap-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-text-main mb-2">{cmsData.k2Title}</h3>
                    <p className="text-text-main/75 leading-relaxed">
                      {cmsData.k2Desc}
                    </p>
                  </div>
              ...
              <FadeIn direction="up" delay={0.3}>
                <div className="flex gap-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-text-main mb-2">{cmsData.k3Title}</h3>
      ...
      <section aria-label="Momen Menikmati Gipang" className="py-20 bg-primary-dark">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <FadeIn direction="up">
            <p className="text-center text-xl md:text-2xl font-medium text-text-main max-w-4xl mx-auto leading-relaxed px-4" dangerouslySetInnerHTML={{ __html: cmsData.temanNgopiText.replace('Gipang Cilegon', '<span className="font-bold text-accent">Gipang Cilegon</span>') }}>
            </p>
          </FadeIn>
        </div>
      </section>
              ...
              <div className="flex -ml-4 md:-ml-8">
                ...
                <div className="pl-4 md:pl-8 flex-[0_0_90%] md:flex-[0_0_33.333%] min-w-0">
                  <motion.div 
                    ...
                    transition={{ type: "spring", bounce: 0.5, duration: 0.8, delay: 0 }}
                  ...
                  >
                    ...
                    <div className="flex items-center gap-4 border-t border-black/5 pt-6 mt-auto">
                      ...
                      <div>
                        <h4 className="font-bold text-text-main">Rina</h4>
                        <p className="text-sm text-text-main/60">JKT</p>
                      </div>
                    </div>
                  </motion.div>
                </div>
                ...
                <div className="pl-4 md:pl-8 flex-[0_0_90%] md:flex-[0_0_33.333%] min-w-0">
                  ...
                  >
                    ...
                    <div className="flex items-center gap-4 border-t border-black/5 pt-6 mt-auto">
                      ...
                      <div>
                        <h4 className="font-bold text-text-main">Budi</h4>
                        <p className="text-sm text-text-main/60">BDG</p>
                      </div>
                    </div>
                  </motion.div>
                </div>
                ...
                <div className="pl-4 md:pl-8 flex-[0_0_90%] md:flex-[0_0_33.333%] min-w-0">
                  ...
                  >
                    ...
                    <div className="flex items-center gap-4 border-t border-black/5 pt-6 mt-auto">
                      ...
                      <div>
                        <h4 className="font-bold text-text-main">Dinda</h4>
                        <p className="text-sm text-text-main/60">SBY</p>
                      </div>
                    </div>
                  </motion.div>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {articles.slice(0, 3).map(article => (
                <FadeIn key={article.id} direction="up" className="h-full">
                  <Link to={`/artikel/${article.slug}`} className="group bg-white rounded-2xl shadow-sm border border-black/5 overflow-hidden flex flex-col h-full hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                    <div className="overflow-hidden">
                      {article.coverImage ? (
                         <img src={article.coverImage} alt={article.title} className="w-full h-48 object-cover group-hover:scale-105 transition-transform duration-500" />
                      ) : (
                         <div className="w-full h-48 bg-gradient-to-tr from-accent/20 to-primary flex items-center justify-center group-hover:scale-105 transition-transform duration-500">
                           <span className="text-accent/60 font-serif italic text-xl tracking-wider">{cmsData.logoTextMain}</span>
                         </div>
                      )}
                    </div>
                    <div className="p-6 flex flex-col flex-grow">
                      <h3 className="text-xl font-bold mb-3 text-text-main group-hover:text-accent transition-colors line-clamp-2">{article.title}</h3>
                      <p className="text-text-main/70 mb-8 line-clamp-3 leading-relaxed">{article.excerpt}</p>
      ...
      <section id="pesan" className="py-24 bg-[#E0D8C3] relative overflow-hidden">
        {/* Decorative elements */}
          ...
          <FadeIn direction="up">
            ...
            <div className="flex flex-col sm:flex-row flex-wrap items-center justify-center gap-4 md:gap-5">
              <motion.a 
                ...
                className="w-full sm:w-auto flex items-center justify-center gap-3 bg-shopee text-white px-8 py-4 rounded-2xl font-bold text-lg shadow-[0_8px_30px_rgb(238,77,45,0.4)] hover:shadow-[0_15px_40px_rgb(238,77,45,0.6)] transition-all border border-shopee/50"
              >
              ...
              <motion.a 
                ...
                className="w-full sm:w-auto flex items-center justify-center gap-3 bg-tokopedia text-white px-8 py-4 rounded-2xl font-bold text-lg shadow-[0_8px_30px_rgb(0,170,91,0.4)] hover:shadow-[0_15px_40px_rgb(0,170,91,0.6)] transition-all border border-tokopedia/50"
              >
                <ShoppingBag size={24} aria-hidden="true" />
                Beli di Tokopedia
              </motion.a>
              ...
              <motion.a 
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                href={cmsData.contactWa} 
                target="_blank" rel="noopener noreferrer"
                aria-label="Pesan Gipang Cilegon via WhatsApp"
                className="w-full sm:w-auto flex items-center justify-center gap-3 bg-whatsapp text-white px-8 py-4 rounded-2xl font-bold text-lg shadow-[0_8px_30px_rgb(37,211,102,0.4)] hover:shadow-[0_15px_40px_rgb(37,211,102,0.6)] transition-all border border-whatsapp/50"
              >
      ...
      {/* 7. FOOTER */}
      <footer role="contentinfo" className="bg-white border-t border-black/5 pt-16 pb-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center flex flex-col items-center">
          ...
          />
          <h3 className="text-xl font-bold text-text-main mb-1">{cmsData.footerTitle}</h3>
          <p className="text-text-main/70 italic mb-8 font-medium">{cmsData.footerSlogan}</p>
