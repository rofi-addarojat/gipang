...
const SAMPLE_ARTICLES = [
  {
    ...
    excerpt: 'Gipang telah lama menjadi bagian dari tradisi kuliner masyarakat Banten. Temukan bagaimana cemilan sederhana dari ketan ini bertransformasi menjadi oleh-oleh wajib khas Cilegon.',
...
Bagi warga banten, mencicipi sepotong gipang layaknya mengingat kembali manisnya kenangan masa kecil.`,
  ...
  },
  {
    ...
    excerpt: 'Lupakan biskuit atau kue kering biasa. Jika Anda belum pernah memadukan kopi hitam hangat dengan renyahnya Gipang Cilegon, Anda melewatkan sensasi ngopi yang luar biasa.',
...
Jadi, tunggu apa lagi? Seduh kopi Anda sekarang dan temani dengan renyahnya Gipang Cilegon.`,
  ...
  },
  {
    ...
    excerpt: 'Pernah mengalami gipang menjadi alot setelah beberapa hari? Ikuti tips praktis berikut ini untuk menjaga tekstur gipang Anda agar selalu renyah seperti baru dibeli.',
